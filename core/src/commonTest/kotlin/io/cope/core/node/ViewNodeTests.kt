...
import io.cope.core.fakes.fakeCanvas
import io.cope.core.layout.ColumnScope
...
class ViewNodeTests {
    ...
    fun given_alignment_measure_return_correct_bounds(){
        ...
        viewNode.modifier = with(columnScope){
            Modifier.align(io.cope.core.layout.Alignment.Horizontal.CenterHorizontally)
        }
        val bounds = viewNode.measure(10.0, 0.0, positionable)
    ...
    fun given_draw_return_draw_called(){
        ...
        viewNode.drawing = object: io.cope.core.drawing.Drawing {
